...
`StarfallSimulationHost` accepts packed spawn and retire arrays, advances one fixed step,
and returns packed state/event dictionaries. Invalid array shapes and invalid signed IDs reject
