...
| --- | --- | --- | --- | --- | --- |
| `saga.outer-day-city.pre-rotation` | environment | saga.outer-day-city | 160×90 | not-applicable | approved-concept-candidate |
| `saga.inner-sea-dome.pre-rotation` | environment | saga.inner-sea-dome | 160×90 | not-applicable | approved-concept-candidate |
| `saga.no-down-city.pre-rotation` | environment | saga.no-down-city | 160×90 | not-applicable | approved-concept-candidate |
| `saga.axis-pillar.pre-rotation` | environment | saga.axis-pillar | 160×90 | not-applicable | approved-concept-candidate |
| `saga.dual-pivot-chamber.pre-rotation` | environment | saga.dual-pivot-chamber | 160×90 | not-applicable | approved-concept-candidate |
| `saga.outer-day-city.post-rotation` | environment | saga.outer-day-city | 160×90 | not-applicable | approved-concept-candidate |
| `saga.inner-sea-dome.post-rotation` | environment | saga.inner-sea-dome | 160×90 | not-applicable | approved-concept-candidate |
